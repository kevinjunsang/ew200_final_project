...
SHIELD_1_POSITION = (SCREEN_WIDTH - 3 * TILE_SIZE, SCREEN_HEIGHT - 2 * TILE_SIZE)
SHIELD_2_POSITION = (SCREEN_WIDTH - 2 * TILE_SIZE, SCREEN_HEIGHT - 2 * TILE_SIZE)
SHIELD_3_POSITION = (SCREEN_WIDTH - 1 * TILE_SIZE, SCREEN_HEIGHT - 2 * TILE_SIZE)
WEAPON_1_POSITION = (SCREEN_WIDTH - 3 * TILE_SIZE, SCREEN_HEIGHT - 3 * TILE_SIZE)
WEAPON_2_POSITION = (SCREEN_WIDTH - 2 * TILE_SIZE, SCREEN_HEIGHT - 3 * TILE_SIZE)
WEAPON_3_POSITION = (SCREEN_WIDTH - 1 * TILE_SIZE, SCREEN_HEIGHT - 3 * TILE_SIZE)
KEY_1_POSITION = (SCREEN_WIDTH - 3 * TILE_SIZE, SCREEN_HEIGHT - 4 * TILE_SIZE)
KEY_2_POSITION = (SCREEN_WIDTH - 2 * TILE_SIZE, SCREEN_HEIGHT - 4 * TILE_SIZE)
KEY_3_POSITION = (SCREEN_WIDTH - 1 * TILE_SIZE, SCREEN_HEIGHT - 4 * TILE_SIZE)
